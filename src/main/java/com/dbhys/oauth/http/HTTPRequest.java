...
import com.dbhys.oauth.util.URLUtils;
...
public class HTTPRequest extends HTTPMessage {
	 ...
	 */
	public HTTPRequest(final HTTPRequest.Method method, final URL url) {
	 ...
	 */
	public void ensureMethod(final HTTPRequest.Method expectedMethod)
	...
	public HttpURLConnection toHttpURLConnection()
		...
		if (query != null && (method.equals(HTTPRequest.Method.GET) || method.equals(HTTPRequest.Method.DELETE))) {
